...
function Footer() {
  return (
    <>
      <footer class=" text-center text-white bg-blue  lg:text-left  w-full mt-[200px]">
          ...
          <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="lg:flex hidden">
              <Link to={"/"} className="" href="/">
                <img
                  className="sm:w-[5rem]  sm:h-[5vw]  mid:w-[6rem]  mid:h-[6vw] "
                  src={NavLogo1}
                  alt="logo"
                />
              </Link>{" "}
            ...
            <div className="lg:hidden mid:mx-auto">
              <Link to={"/"} className="" href="/">
                <img
                  className="sm:w-[5rem]   mid:w-[6rem]   "
                  src={NavLogo1}
                  alt="logo"
                />
              </Link>{" "}
